...
2. For the more-application inclined, a showcase of how to use many of these builders can be found in the [Building a Codepack tutorial](/tutorials/buildcodepack). Feel free to assume the black box works, skip all of this, and go do some actual science.
```
...
Rather than have constant forward references, we will only talk about the builders at a high-level here and leave demonstrations to the [Building a Codepack tutorial](/tutorials/buildcodepack).
```
