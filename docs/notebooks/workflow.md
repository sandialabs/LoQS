...
2. A patch label
3. A tuple of any arguments to pass into the `Instruction.apply_fn` (discussed in the [Instruction tutorial](/reference/loqs/core/instructions/instruction/Instruction/))
4. A dict of any keyword arguments to pass into the `Instruction.apply_fn` (discussed in the [Instruction tutorial](/reference/loqs/core/instructions/instruction/Instruction/))
