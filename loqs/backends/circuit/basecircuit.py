...
class BasePhysicalCircuit(SeqCastable, Displayable):
    ...
    def from_circuit_tiling(
        ...
        tile_qubits:
            ...
            [qubit_labels](api:BasePhysicalCircuit.qubit_labels)). Tiles will be added in the provided order
            of the mappings.
    ...
    def append(self: T, circuit: BasePhysicalCircuit) -> T:
        ...
        ----------
        circuit:
            See [append_inplace](api:BasePhysicalCircuit.append_inplace)
    ...
    def delete_qubits(self: T, qubits_to_delete: Sequence) -> T:
        ...
        qubits_to_delete : Sequence
            See [delete_qubits_inplace](api:BasePhysicalCircuit.delete_qubits_inplace)
    ...
    def insert(self: T, circuit: BasePhysicalCircuit, idx: int) -> T:
        ...
        ----------
        circuit:
            See [insert_inplace](api:BasePhysicalCircuit.insert_inplace)
    ...
    def merge(self: T, circuit: BasePhysicalCircuit, idx: int) -> T:
        ...
        While [insert](api:BasePhysicalCircuit.insert) adds new layers, [merge](api:BasePhysicalCircuit.merge)
        will try to add operations to existing layers.

        Parameters
        ----------
        circuit:
            See [merge_inplace](api:BasePhysicalCircuit.merge_inplace)
    ...
    def pad_single_qubit_idles(self: T, idle_name: str) -> T:
        ...
        Other Parameters
        ----------------
        See [pad_single_qubit_idles_inplace](api:pad_single_qubit_idles_inplace)
        """
        modified_circuit = self.copy()
    ...
    def pad_single_qubit_idles_by_duration(
        ...
        ----------
        idle_names:
            See [pad_single_qubit_idles_by_duration_inplace](api:BasePhysicalCircuit.pad_single_qubit_idles_by_duration_inplace)
    ...
    def set_qubit_labels(self: T, qubit_labels: Sequence) -> T:
        ...
        ----------
        qubit_labels:
            See [set_qubit_labels_inplace](api:BasePhysicalCircuit.set_qubit_labels_inplace)
    ...
    def set_qubit_labels_inplace(self, qubit_labels: Sequence) -> None:
        ...
        [map_qubit_labels_inplace](api:BasePhysicalCircuit.map_qubit_labels_inplace) instead.
