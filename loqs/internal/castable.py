...
class Castable:
    ...
    By default, a [](api:Castable) object is one that can be
    ...
    They also have a [](api:Castable.cast) function, which either does nothing
    ...
    def __init__(self, obj: object) -> None:
        """Construct a [](api:Castable) object.
...
class SeqCastable(Castable):
    """[](api:Castable) object whose first argument is a `list` or `tuple`."""

    @classmethod
    def cast(cls: type[U], obj: object) -> U:
        """Cast to the derived class.

        The difference from [](api:Castable.cast) is that we are
...
class MapCastable(Castable):
    """[](api:Castable) object whose first argument is a `dict`."""
