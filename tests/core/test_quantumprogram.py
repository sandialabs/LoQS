...
class TestResumeFromCheckpoint:
    ...
    def test_resume_restores_shot_wall_clock_times_lazy_loading_true(self, monkeypatch):
    ...
    def test_resume_restores_shot_wall_clock_times_lazy_loading_false(self, monkeypatch):
