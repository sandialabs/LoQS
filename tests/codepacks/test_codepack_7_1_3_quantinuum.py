...
class TestSteaneCodepack:
    ...
    def _create_program(circuit_backend, model_backend, state_backend):
        ...
        stack = [
            ...
            {"instruction": "Init Patch Steane", "new_patch_label": "L0", "qubits": qubits}, # Autogenerated from patch_types. Note that 5Q here must be a key into the patch_types dict below
            ("Non-FT Zero Prep", "L0"),
    ...
    def test_nonft_workflow(self, circuit_backend, model_backend, state_backend, stack_outcome):
        ...
        stack = [
            ...
            {"instruction": "Init Patch Steane", "new_patch_label": "L0", "qubits": self.qubits},
            ("Non-FT Zero Prep", "L0"),
        ]
