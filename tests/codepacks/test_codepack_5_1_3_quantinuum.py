...
class Test5QCodepack:
    ...
    def test_ft_workflow(
        ...
        program = QuantumProgram.from_quantum_program(
            ref_program, InstructionStack(stack_ft)
        )
        program_results = program.run()
        assert (
            program_results.collect_shot_data("logical_measurement", -1)[0]
    ...
    def test_all_discrete_errors_meas(self):
        ## PART I
        stack_ftmeas_partI = InstructionStack(
            [
                {
                    "instruction": "Init State",
                    "state": len(self.qubits),
        ...
        stack_ftmeas_partII = InstructionStack(
            [
                {
                    "instruction": "Init State",
                    "state": len(self.qubits),
        ...
        stack_ftmeas_partIII = InstructionStack(
            [
                {
                    "instruction": "Init State",
                    "state": len(self.qubits),
    ...
    def test_ft_prep_deep_spotcheck(self):
        stack_ftprep_D3X_error = InstructionStack(
            [
                {
                    "instruction": "Init State",
                    "state": len(self.qubits),
        ...
        assert fttools.test_program_output(
            ...
            collect_shot_data_args=[
                ...
                (
                    "measurement_outcomes",
                    5,
                ),  # Let's do it again for the second round (frame 3 is the reset)
                ("rus_success", 6),
                (
                    "logical_measurement",
                    -1,
    ...
    def test_ft_meas_deep_spotcheck(self):
        stack_ftmeas_partI_D2Z_error = InstructionStack(
            [
                {
                    "instruction": "Init State",
                    "state": len(self.qubits),
        ...
        assert fttools.test_program_output(
            ...
            collect_shot_data_args=[
                ...
                (
                    "log",
                    7,
                ),  # Double-check this is the Part I feed-forward result
                ...
                (
                    "log",
                    9,
                ),  # Double-check this is the Part II feed-forward result
                ...
                (
                    ...
                    11,
                ),  # Let's see that the decoder picked out the correct error...
                (
                    "corrected_outcomes",
                    11,
        ...
        stack_ftmeas_partI_M1X_error = InstructionStack(
            [
                {
                    "instruction": "Init State",
                    "state": len(self.qubits),
